...
```{r, echo=FALSE, out.width='80%', fig.width=7, fig.height=5,fig.align='center', fig.cap = "Pris for 1.klasse og avreisehavn."}
...
```{r, echo=FALSE, out.width='80%', fig.width=7, fig.height=5,fig.align='center', fig.cap = "Antall passasjerer per tittel"}
...
```{r, echo=FALSE, out.width='80%', fig.width=7, fig.height=5,fig.align='center', fig.cap = "Kabin fordeling per klasse"}
...
```{r, echo=FALSE, out.width='80%', fig.width=7, fig.height=5,fig.align='center', fig.cap = "Faktorinnvirkning Lasso og Random Forrest"}
vip_lso_rf <- vip_lso_rf(tuned_lso, tuned_rf, t_train)
plot_vip_lso_rf(vip_lso_rf)
```

```{r, echo=FALSE, out.width='80%', fig.width=7, fig.height=5,fig.align='center', fig.cap = "Faktorinnvirkning XGB"}
...
```{r, echo=FALSE, out.width='80%', fig.width=7, fig.height=5,fig.align='center', fig.cap = "Pris for klasse og avreisedestinasjon."}
