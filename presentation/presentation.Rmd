...
### Tren modeller
Vi fant ut at de mest relevant modellene for problemet var Lasso, Random Forest og Gradient Boosting Tree. Her implementerer vi dem, og finner de beste hyperparameterne. TODO: SKRIVE OM HVORFOR VI VALGTE PARAMETERNE. OM DET ER FORDI BEST PRACTICE, SÅ SKRIV DET. -> Vi laget en funksjon som tar inn modelnavn som parameter, og utifra navnet lager den en modelspesifikkasjon samt en grid med potensielle hyperparameter. Spennet av verdier i dette griddet har vi valgt basert på det som virker som konsensus på blant annet Stack Overflow (eW, noe annet?). Videre bruker den tune_grid() fra tune-biblioteket i Tidyverse i kombinasjon med select_best() til å finne hvilke hyperparametere som sammen gir den beste treffsikkerheten. 
```{r, results='hide', message=FALSE}
# Tuned models
