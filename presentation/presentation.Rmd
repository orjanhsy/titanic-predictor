...
#code in norwegian because knitr::kable uses 
accs <- tibble (
  Model = c("LASSO", "RANDOM FOREST", "XGBOOST"),
  Treffsikkerhet = c(tuned_lso_acc, tuned_rf_acc, tuned_xgb_acc)
)
...
Vi mener fremdeles at vi har gjort en god innsats med å forberede dataen til vår evne. Selv om vi nå - med vår nye læring og kunnskap - ser at det er forbedringer vi kunne gjort. Ettersom noe av den læringen er hentet fra andres arbeid går vi ikke i detalj. 
